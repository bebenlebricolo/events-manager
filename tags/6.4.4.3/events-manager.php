...
// Setting constants
define('EM_VERSION', '6.6.4.3'); //self expanatory, although version currently may not correspond directly with published version number. until 6.0 we're stuck updating 5.999.x
