			...
			<table class='form-table'>
				...
				<tbody class="em-phone-options" id="em-phone-settings">
					<?php
						...
						em_options_select( esc_html__('Default Country', 'em-pro'), 'dbem_phone_default_country', $phone_countries, esc_html__('The selected country will be chosen by default if auto-detect is disabled, additionally any numbers submitted whilst Phone Numbers were disabled will be considered as belonging to this country and reformatted accordingly when used for communication or display purposes.', 'em-pro'), '', array(), array('selectize' => true) );
						...
						em_options_select( esc_html__('Include Countries', 'em-pro'), 'dbem_phone_countries_include', $phone_countries, esc_html__('Only the selected countries will be included in the country selection list. This takes precedence over excluded countries.', 'em-pro'), '', array(), array('selectize' => true, 'multiple' => true) );
						em_options_select( esc_html__('Exclude Countries', 'em-pro'), 'dbem_phone_countries_exclude', $phone_countries, esc_html__('These countries will be excluded from the country selection list.', 'em-pro'), '', array(), array('selectize' => true, 'multiple' => true) );
					?>
				</tbody>
				<?php echo $save_button; ?>
			</table>
